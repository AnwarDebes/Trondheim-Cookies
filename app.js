...
const I18N = {
  en: {
    ...
    deliveryHint: "Free home delivery in the Trondheim area on 3+ cookies.",
    deliveryNote: "Order <b>3 cookies or more</b> and we bring them <b>free to your door, anywhere in the Trondheim area</b>, city included. Under 3 cookies it's pickup or a small delivery fee. We deliver throughout Trondheim and its surrounding area, but not outside it. Pay with Vipps or cash on handover.",
    orderBody: "No payment online, you pay on delivery. Free home delivery across the Trondheim area on 3+ cookies; under 3 it's pickup or a small fee. We deliver within Trondheim and nearby only, not outside the area.",
    footDel1: "Free home delivery · 3+",
    footDel2: "Under 3: pickup or fee",
    footDel3: "Trondheim area only",
    trust1: "Free home delivery (3+)",
    ...
    delivFree: "\u2713 Free home delivery in the Trondheim area unlocked",
    delivNudge: (n) => `Add ${n} more cookie${n > 1 ? "s" : ""} for free home delivery`,
  ...
  no: {
    ...
    deliveryHint: "Gratis hjemlevering i Trondheimsområdet ved 3+ cookies.",
    deliveryNote: "Bestiller du <b>3 cookies eller mer</b>, kjører vi dem <b>gratis hjem til deg, hvor som helst i Trondheimsområdet</b>, byen inkludert. Under 3 cookies blir det henting eller et lite leveringsgebyr. Vi leverer i hele Trondheim og områdene rundt, men ikke utenfor. Betal med Vipps eller kontant ved levering.",
    orderBody: "Ingen betaling på nett, du betaler ved levering. Gratis hjemlevering i hele Trondheimsområdet ved 3 cookies eller mer; under 3 blir det henting eller et lite gebyr. Vi leverer kun i Trondheim og områdene rundt, ikke utenfor.",
    footDel1: "Gratis hjemlevering · 3+",
    footDel2: "Under 3: henting eller gebyr",
    footDel3: "Kun Trondheimsområdet",
    trust1: "Gratis hjemlevering (3+)",
    ...
    delivFree: "\u2713 Gratis hjemlevering i Trondheimsområdet låst opp",
    delivNudge: (n) => `Legg til ${n} cookie${n > 1 ? "s" : ""} til for gratis hjemlevering`,
  ...
  ar: {
    ...
    deliveryHint: "توصيل منزلي مجاني في منطقة تروندهايم عند 3 كوكيز أو أكثر.",
    deliveryNote: "اطلب <b>3 كوكيز أو أكثر</b> ونوصّلها <b>مجانًا إلى باب منزلك في أي مكان داخل منطقة تروندهايم</b> بما في ذلك المدينة. أقل من 3 كوكيز يكون الاستلام أو رسوم توصيل بسيطة. نوصّل في كل تروندهايم والمناطق المحيطة بها، وليس خارجها. ادفع بـ Vipps أو نقدًا عند الاستلام.",
    orderBody: "لا دفع عبر الإنترنت، تدفع عند الاستلام. توصيل منزلي مجاني في كل منطقة تروندهايم عند 3 كوكيز أو أكثر؛ وأقل من 3 يكون الاستلام أو رسوم بسيطة. نوصّل داخل تروندهايم والمناطق المحيطة فقط، وليس خارجها.",
    footDel1: "توصيل منزلي مجاني · 3+",
    footDel2: "أقل من 3: استلام أو رسوم",
    footDel3: "منطقة تروندهايم فقط",
    trust1: "توصيل منزلي مجاني (3+)",
    trust4: "ضمان رضا 100%",
    footProm3: "ضمان الرضا",
    guaranteeNote: "لست راضيًا عن كوكيزك؟ أخبرنا وسنصلح الأمر. رضاك دائمًا في المقام الأول.",
    delivFree: "\u2713 تم تفعيل التوصيل المنزلي المجاني في منطقة تروندهايم",
    delivNudge: (n) => `أضف ${n} كوكي للحصول على توصيل منزلي مجاني`,
